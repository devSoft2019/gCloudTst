...
import com.gcloud.deviceHandler.persistence.DataStore;
...
public class DeviceHandlerAPIImpl implements DeviceHandlerAPI{
    ...
    @Override
    @ResponseBody
    public ResponseEntity<Device> getDeviceByMcAdress(final String macAdress) {
        try{
    ...
    @Override
    @ResponseBody
    public ResponseEntity<Device> getDeviceByIdDevice(final int idDevice) {
        try{
